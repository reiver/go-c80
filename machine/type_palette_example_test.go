...
func ExampleType_Palette() {
	...
	machine.Palette().Color(0).Poke(   1,  1,  1, 255)
	machine.Palette().Color(1).Poke( 222, 56, 43, 255)
	machine.Palette().Color(2).Poke(  57,181, 74, 255)
	machine.Palette().Color(3).Poke( 255,199,  6, 255)
	machine.Palette().Color(4).Poke(   0,111,184, 255)
	machine.Palette().Color(5).Poke( 118, 38,113, 255)
	machine.Palette().Color(6).Poke(  44,181,233, 255)
	machine.Palette().Color(7).Poke( 204,204,204, 255)
	machine.Palette().Color(8).Poke( 128,128,128, 255)
	machine.Palette().Color(9).Poke( 255,  0,  0, 255)
	machine.Palette().Color(10).Poke(  0,255,  0, 255)
	machine.Palette().Color(11).Poke(255,255,  0, 255)
	machine.Palette().Color(12).Poke(  0,  0,255, 255)
	machine.Palette().Color(13).Poke(255,  0,255, 255)
	machine.Palette().Color(14).Poke(  0,255,255, 255)
	machine.Palette().Color(15).Poke(255,255,255, 255)
